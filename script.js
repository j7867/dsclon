...
async function hangUpCall() {
    ...
    const placeholder = document.getElementById('voiceAvatarPlaceholder'); if (placeholder) placeholder.style.display = 'flex'; currentRoomId = null;
}
